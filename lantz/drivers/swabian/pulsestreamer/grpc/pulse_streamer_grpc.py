...
try:
    ...
    from lantz.drivers.swabian.pulsestreamer.grpc.pulse_streamer_pb2 import VoidMessage, PulseMessage, SequenceMessage, ClockMessage, DrpClkSetMessage, TriggerMessage, SetNetworkMessage, GetNetworkMessage, HostnameMessage, PulseStreamerStub, SetSquareWaveMessage, AnalogCalibrationData, SupplyStatusData
    from lantz.drivers.swabian.pulsestreamer.grpc.pulse_streamer_pb2 import GetSerialMessage # used for backwards compatibility reasons if client software detects firmware version < 1.1.0
